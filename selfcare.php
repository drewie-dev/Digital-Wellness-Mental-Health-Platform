...
<section class="page intro selfcare intro">
    <div>
        <h1>Self Care</h1>
        <p>A few small tools to help you reset. No sign up, just take a minute.</p>
    </div>
    <img src="images/meditate_1.jpg" alt="Illustration of a person pausing to breathe and reset" class="intro img">
</section>
...
<section class="breathing section">
    ...
    <div class="breathing visual">
        <img src="images/breathing.png" alt="Illustration of a person sitting cross legged practicing deep breathing" class="breathing img">
